...
class Device:
    ...
    def get_capture(self, timeout_in_ms=_k4a.K4A_WAIT_INFINITE):
        ...
        _k4a.VERIFY(_k4a.k4a_device_get_capture(
            self._handle, capture_handle, timeout_in_ms), "Get capture failed!")
    ...
    def get_imu_sample(self, timeout_in_ms=_k4a.K4A_WAIT_INFINITE):
        ...
        _k4a.VERIFY(_k4a.k4a_device_get_imu_sample(
            self._handle, imu_sample, timeout_in_ms), "Get IMU failed!")
    ...
    def start_cameras(self, device_config):
        ...
        _k4a.VERIFY(_k4a.k4a_device_start_cameras(
            self._handle, device_config.handle()), "Start K4A cameras failed!")
    ...
    def start_imu(self):
        ...
        _k4a.VERIFY(_k4a.k4a_device_start_imu(
            self._handle), "Start K4A IMU failed!")
    ...
    def get_serialnum(self):
        ...
        result = _k4a.k4a_device_get_serialnum(
        ...
        _k4a.VERIFY(_k4a.k4a_device_get_serialnum(
            self._handle, serial_number, serial_number_size), "Read serial number failed!")
    ...
    def get_calibration(self, depth_mode, color_resolution):
        ...
        _k4a.VERIFY(_k4a.k4a_device_get_calibration(self._handle, depth_mode,
                    color_resolution, calibration_handle), "Get calibration failed!")
    ...
    def get_version(self):
        ...
        _k4a.VERIFY(_k4a.k4a_device_get_version(
            self._handle, version), "Get version failed!")
    ...
    def open(index=0):
        ...
        _k4a.VERIFY(_k4a.k4a_device_open(index, device_handle),
