...
def k4a_device_get_capture(device_handle, capture_handle, timeout):
    ...
    _k4a_device_get_capture.argtypes = (
        k4a_device_t, ctypes.POINTER(k4a_capture_t), ctypes.c_int32)
...
def k4a_device_get_imu_sample(device_handle, imu_sample_handle, timeout):
    ...
    _k4a_device_get_imu_sample.argtypes = (
        k4a_device_t, ctypes.POINTER(k4a_imu_sample_t), ctypes.c_int32)
...
def k4a_device_start_cameras(device_handle, config):
    ...
    _k4a_device_start_cameras.argtypes = (
        k4a_device_t, ctypes.POINTER(k4a_device_configuration_t),)
...
def k4a_device_get_serialnum(device_handle, serial_number, serial_number_size):
    ...
    _k4a_device_get_serialnum.argtypes = (
        k4a_device_t, ctypes.c_char_p, ctypes.POINTER(ctypes.c_size_t))
...
def k4a_device_get_version(device_handle, hardware_version):
    ...
    _k4a_device_get_version.argtypes = (
        k4a_device_t, ctypes.POINTER(k4a_hardware_version_t),)
